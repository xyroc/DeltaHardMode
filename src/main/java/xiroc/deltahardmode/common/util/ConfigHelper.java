...
public class ConfigHelper {
	...
	public static void loadConfig() {
		...
		if (config.hasChanged())
			config.save();*/
		loaded = true;
		DeltaHardMode.LOGGER.info("GRAVITY = " + toggles.get("GRAVITY"));
		DeltaHardMode.LOGGER.info("NO_OBSIDIAN = " + toggles.get("NO_OBSIDIAN"));
		DeltaHardMode.LOGGER.info("LOOT = " + toggles.get("LOOT"));
		DeltaHardMode.LOGGER.info("CHANGE_BONEMEAL = " + toggles.get("CHANGE_BONEMEAL"));
		DeltaHardMode.LOGGER.info("NO_SLEEP = " + toggles.get("NO_SLEEP"));
		DeltaHardMode.LOGGER.info("SKELETON_NO_BOW_DROP = " + toggles.get("SKELETON_NO_BOW_DROP"));
		DeltaHardMode.LOGGER.info("SPIDER_NO_STRING_DROP = " + toggles.get("SPIDER_NO_STRING_DROP"));
	}
