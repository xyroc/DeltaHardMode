...
public class ExplosionHelper {
	...
	public static Explosion newExplosion(@Nullable Entity entityIn, World world, double x, double y, double z, float radius, boolean isFlaming, boolean damage) {
		Explosion explosion = new Explosion(world, entityIn, x, y, z, radius, isFlaming, damage ? Explosion.Mode.DESTROY : Explosion.Mode.NONE);
		if (!world.isRemote)
	...
	public static void spawnLingeringCloud(CreeperEntity creeper) {
		...
		if (!collection.isEmpty()) {
			AreaEffectCloudEntity entityareaeffectcloud = new AreaEffectCloudEntity(creeper.world, creeper.posX, creeper.posY, creeper.posZ);
