...
public class Reference {
    ...
    public static final String VERSION_STRING = "0.5.7";
...
//						DeltaHardMode.LOGGER.info("A new version of Delta Hard Mode is out: " + newVersionString);
//					}
//				} catch (Exception e) {
//					DeltaHardMode.LOGGER.error("Version check failed: " + e.getMessage());
//				}
//
//			}
//		}).start();
